 ...
 * @access public
 */
class JavaScript extends Visio\Application\Response\BaseResponse implements Visio\Application\IResponse {
    ...
    public function send(Visio\Http\Response $httpResponse, Visio\Http\Request $httpRequest, Visio\DependencyInjection\IContainer $container) {
        ...
        $httpResponse->setContentType("text/javascript", "utf-8");

        Visio\Events::dispatch("ResponseHtml-onSend", array(&$this, &$respond));
