...
/**
 * Response class for Extensible Markup Language
 *
 ...
 * @access public
 */
class Xml extends Visio\Application\Response\BaseResponse implements Visio\Application\IResponse {
    ...
    public function send(Visio\Http\Response $httpResponse, Visio\Http\Request $httpRequest, Visio\DependencyInjection\IContainer $container) {
        ...
        Visio\Events::dispatch("ResponseJson-onSend", array(&$this,
                                                            &$respond));
